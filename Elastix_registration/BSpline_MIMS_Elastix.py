...
parameter_object.AddParameterFile('/Users/pronomabanerjee/Downloads/parameters_Bspline_Multimetric.txt')
...
itk.imwrite(result_image_transformix,'exampleoutput/bspline_multimetric.mhd')